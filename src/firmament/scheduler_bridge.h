...
class SchedulerBridge {
 ...
 private:
  ...
  // directly insert values in these data structures. However, we can query
  // them.
  ...
  // Mapping from PU ResourceID_t to node ResourceID_t.
  unordered_map<ResourceID_t, ResourceID_t,
    boost::hash<boost::uuids::uuid>> pu_to_node_map_;
