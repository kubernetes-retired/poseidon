...
func init() {
	const (
		defaultK8sVersion = "1.6"
		defaultKubeConfig = "/root/admin.conf"
	)
	// go test -kube-version="1.6" -kubeconfig="/root/admin.conf"
	// To override default values pass -kube-version -kubeconfig flags
	flag.StringVar(&kubeVersion, "kube-version", defaultK8sVersion, "a string")
	flag.StringVar(&kubeConfig, "kubeconfig", defaultKubeConfig, "a string")
}
