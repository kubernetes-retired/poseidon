...
func newTestK8sClient(t *testing.T) *TestK8sClient {
	...
	testK8sClient.schedulerName = "poseidon"
	testK8sClient.kubeConfig = ""
	testK8sClient.kubeClient = *fake.Clientset{}
	// initialzing clientSet of k8sclient.go
...
func TestNew(t *testing.T) {
	...
	// TODO(karun): see if New can be called,
